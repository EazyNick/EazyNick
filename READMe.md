...
<p>
  ...
  <span style="color: #1E90FF; font-size: 16px;">📚 Transformer + RL 알고리즘 활용한 시스템 트레이딩 모델 개발중(비공개, 라이센스 有) <br>
  <span style="color: #1E90FF; font-size: 16px;">📚 정보처리기사 실기 공부중 <br>
</p>
...
| Project   | Summary                                           | Role      | Stack                          | Period                |
|---------|---------------------------------------------------|-----------|--------------------------------|--------------------------|
| AstraQuant | 주가 예측 시스템, 2023~2025 테스트 데이터 결과: 연간 수익률 24.8%, 2025.01~2025.02 현재 수익률 9.7%, 구매 문의:kkkygsos@naver.com | - | Python | 2025.02~ |
